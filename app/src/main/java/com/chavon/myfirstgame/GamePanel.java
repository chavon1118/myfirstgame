...
/**
 * Created by Chavon on 2015-07-10.
 */
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public boolean onTouchEvent(MotionEvent event){
        if(event.getAction() == MotionEvent.ACTION_DOWN  ) {
            if (!player.getPlaying() && newGameCreated && reset) {
                ...
                player.setUp(true);
                // play music
                Game.mediaPlayer = MediaPlayer.create(this.getContext(),R.raw.bgmusic);
                Game.mediaPlayer.start();
                Game.mediaPlayer.setLooping(true); // Set looping
                Game.mediaPlayer.setVolume(100,100);
            }
    ...
    public void update(){
        if(player.getPlaying()) {
            ...
            if(missilesElapsed > (2000-player.getScore()/4)){
                ...
                }else if(missiles.size()<10){
                   missiles.add(new Missile(BitmapFactory.decodeResource(getResources(), R.drawable.missile),
                           WIDTH+10, (int)(rand.nextDouble()*(HEIGHT-(maxBorderHeight*2))+maxBorderHeight+15),
    ...
    public void  draw(Canvas canvas){
        //getWidth gives the width of screen
